...
import { FaPaw, FaClock, FaCheckCircle } from "react-icons/fa";
import Header from "../Header/Header";
import Footer from "../footer/Footer";
import axios from "axios";
import { Link,useNavigate } from "react-router-dom";

export default function PetFindJob() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
      const url = 'http://localhost/sem-6care4all-master/backend/PetJob.php';
  ...
  return (
    <>
      ...
      <p className="text-gray-700 text-lg mb-6">Answer a few questions to find the best pet care opportunities.</p>
      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 w-full max-w-2xl">
        ...
        <div className="mb-4">
          <label className="text-lg font-semibold text-gray-800 flex items-center">
            ...
            What pet care services can you provide?
          </label>
          <div className="grid grid-cols-2 gap-3 mt-2">
            {["Dog Walking", "Pet Sitting", "Grooming", "Training", "Vet Visits", "Overnight Care"].map(
              (service) => (
                <div
                  key={service}
        ...
        {/* Submit Button */}
        <button type="submit" className="btns accent2-text border-2 border-green-700 text-lg font-semibold px-6 py-3 rounded-full w-full mt-6 hover:bg-orange-600 transition">
          Find Jobs
        </button>
      </div>
      </form>
